...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=1]{fig/bohrmystery.png}
...
If the distance between mirrors on the space shit is $d$, and for the astronaut the time ($\tau$) it takes the light to go complete one round trip is $\frac{d}{\tau}$ or $d = c \tau$. For an observer on the ground, it takes $ct$ to complete the same trip.
