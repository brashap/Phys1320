...
Additionally, because $\Delta x$ is small, the magnetic flux through the face can be approximated by its value in the center of the area traversed, specifically $B_z(x + \frac{\Delta x}{2},t)$. The flux on Side 3 is therefore
