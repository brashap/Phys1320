...
Lenz's Law\footnote{named in honor of Heinrich Lorz (1804-1865), but also discovered independently by Michael Faraday}: The direction of the induced emf drives a current around the a wire loop to always oppose the change in magnetic flux that cuases the emf. 
...
Consider a rectangular coil of area $A$ and $N$ turns placed in a uniform magnetic field $\vec{B} = B \hat{j}$ as shown in Figure 
...
Consider the setup in Figure \ref{fig:fig_16_03}.
